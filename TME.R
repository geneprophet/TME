...
#geneSet[["INF-gamma"]] = c("ID01","CXCL10","CXCL9","HLA-DRA","STAT1","INFG","CD3D","CIITA","CD3E","CCL5","CZMK","CD2","CXCL13","IL2RG","NKG7","HLA-E","CXCR6","LAG3","TAGAP","GZMB")
...
## ssgsea score
library("GSVA")
gsva.es <- gsva(expressionMatrix, geneSet3,method="ssgsea", verbose=FALSE)
dim(gsva.es)
gsva.es[1:5, 1:5]
## louvain clustering
# library(igraph)
